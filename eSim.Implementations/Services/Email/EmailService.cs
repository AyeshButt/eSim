...
namespace eSim.Implementations.Services.Email
{
    public class EmailService : IEmailService
    {
        ...
        public EmailService(ApplicationDbContext db, IOptions<EmailConfig> options, IConfiguration config)
        {
            _db = db;
            _options = options;
            _config = config;
        ...
        public Result<string> SendEmail(EmailDTO input)
        {
            ...
            try
            {
                ...
                message.To.Add(new MailboxAddress("Recipient", BusinessManager.EmailTo));
